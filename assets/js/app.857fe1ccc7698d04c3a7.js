...
module.exports = {
    ...
    created: function created() {
        ...
        $(window).bind('beforeunload', function (e) {
            if (self.dirty) return "Unsaved changes in list " + self.list.name;else e = null; // i.e; if form state change show warning box, else don't show it.
        });
    },
    mounted: function mounted() {
        var self = this;
    ...
    methods: {
        listEdit: function listEdit(list) {
        ...
        save: function save() {
            var self = this;
            axios.defaults.headers.common['X-WP-Nonce'] = listig.nonce;
            axios.post(listig.restUrl + '/listing/' + self.list.id + '/posts', self.list).then(function (response) {
                self.dirty = false;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('nav', {
    ...
    class: {
      'panel-block initial-area': _vm.list.posts.length == 0
    },
    attrs: {
      "list": _vm.list.posts,
      "options": {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.post.id) ? _c('div', [_c('div', {
    staticClass: "box"
  }, [_c('h2', {
