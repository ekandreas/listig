...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        edit: function edit(listId) {
            ...
            axios.get(listig.restUrl + '/listing/' + listId).then(function (response) {
...
module.exports = {
    ...
    mounted: function mounted() {
        var self = this;
        axios.defaults.headers.common['X-WP-Nonce'] = listig.nonce;
        axios.get(listig.restUrl + '/listing/' + self.id).then(function (response) {
            self.dirty = false;
    ...
    methods: {
        ...
        changeImage: function changeImage() {
            ...
            self.file_frame.on('select', function () {
                ...
                axios.defaults.headers.common['X-WP-Nonce'] = listig.nonce;
                axios.get(listig.restUrl + '/helper/attachment/url/' + imageId).then(function (response) {
...
module.exports = {
    data: function data() {
        return {
            ...
            links: [{ title: 'Lists', url: '?page=listig/main' }, { title: 'Settings', url: '?page=listig/settings' }]
        };
    }
};
...
module.exports = {
    data: function data() {
        return {
            links: [{ title: 'Lists', url: '?page=listig/main' }, { title: 'Help', url: '?page=listig/help' }],
...
window.ListigPostPreview = __webpack_require__(58);
window.ListigPostEdit = __webpack_require__(57);
window.ListigPostSearch = __webpack_require__(59);
window.ListigListEdit = __webpack_require__(54);
window.ListigListItem = __webpack_require__(55);
window.ListigListings = __webpack_require__(56);

window.ListigTopMenu = __webpack_require__(60);
window.ListigMainPage = __webpack_require__(62);
window.ListigSettingsPage = __webpack_require__(63);
window.ListigHelpPage = __webpack_require__(61);

window.draggable = __webpack_require__(86);
...
Component.options.__file = "/Users/aek/app/listig/web/app/plugins/listig/resources/vue/components/list-item.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-511fb051", Component.options)
  } else {
    hotAPI.reload("data-v-511fb051", Component.options)
  }
})()}
...
Component.options.__file = "/Users/aek/app/listig/web/app/plugins/listig/resources/vue/pages/help-page.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] help-page.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8721a2d0", Component.options)
  } else {
    hotAPI.reload("data-v-8721a2d0", Component.options)
  }
})()}
...
Component.options.__file = "/Users/aek/app/listig/web/app/plugins/listig/resources/vue/pages/settings-page.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] settings-page.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-04abb514", Component.options)
  } else {
    hotAPI.reload("data-v-04abb514", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-04abb514", module.exports)
  }
}
  ...
  return _c('nav', {
    ...
    on: {
      "change": [function($event) {
        _vm.form.author = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
    ...
    on: {
      "change": [function($event) {
        _vm.form.posttype = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
          var val = "_value" in o ? o._value : o.value;
          return val
    ...
    on: {
      "change": [function($event) {
        _vm.form.postsPerPage = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
          var val = "_value" in o ? o._value : o.value;
          return val
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.id > 0) ? _c('nav', {
    ...
    class: {
      'panel-block initial-area': _vm.posts.length == 0
    },
    attrs: {
      "list": _vm.posts,
      "options": {
    ...
    return _c('div', {
      ...
      class: {
        'active-post': _vm.selectedIndex == _vm.posts.indexOf(post)
      }
    }, [_vm._v(_vm._s(post.headline))])])
  })), _vm._v(" "), (_vm.dirty) ? _c('div', {
    staticClass: "panel-block"
  }, [_c('div', {
    staticClass: "control"
  }, [_c('button', {
  ...
  }, [_vm._v("Save")])])]) : _vm._e()], 1) : _vm._e()
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-511fb051", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.post) ? _c('div', [_c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.post.headline))]), _vm._v(" "), _c('article', {
    staticClass: "media"
  }, [(_vm.post.imageUrl) ? _c('div', {
    staticClass: "media-left"
  }, [_c('figure', {
    staticClass: "image is-64x64"
  }, [_c('img', {
    attrs: {
      "src": _vm.post.imageUrl,
      "alt": "Image"
    }
    ...
    on: {
      ...
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.post.headline = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "panel-block"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.post.imageUrl),
      expression: "post.imageUrl"
    }],
    staticClass: "input",
    attrs: {
      "type": "text"
    ...
    domProps: {
      "value": _vm._s(_vm.post.imageUrl)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.post.imageUrl = $event.target.value
      }
    }
  })])]), _vm._v(" "), (_vm.dirty) ? _c('div', {
    staticClass: "panel-block"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "label"
  }, [_vm._v("ID: " + _vm._s(_vm.form.id))]), _vm._v(" "), _c('label', {
    staticClass: "label"
  ...
  }, [_vm._v(_vm._s(_vm.lang.hideListLabel))]), _vm._v(" "), _c('a', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-8721a2d0", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('post-edit')], 1)]), _vm._v(" "), _c('list-edit', {
    ref: "listEdit"
  })], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
var update = __webpack_require__(3)("30baca35", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-04abb514!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./settings-page.vue", function() {
     var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-04abb514!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./settings-page.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("33fe464a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("2beb4df7", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("c143664c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("05958d28", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-511fb051!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./list-item.vue", function() {
     var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-511fb051!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./list-item.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("11fa51fe", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("1f3c7e3a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("b33c279a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8721a2d0!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./help-page.vue", function() {
     var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-8721a2d0!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./help-page.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("690ca53e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("3bdc8ca6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
